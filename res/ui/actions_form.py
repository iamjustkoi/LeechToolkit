...
class Ui_ActionsForm(object):
    ...
    def retranslateUi(self, ActionsForm):
        ...
        self.forgetRestorePosCheckbox.setToolTip(_translate("ActionsForm", "Restore\'s the cards position to the position it had when it was imported (before other\n"
...
"            "))
        ...
        self.queueRatioSlider.setToolTip(_translate("ActionsForm", "Controls how similar a card\'s fields must be for it to be considered \"similar\".\n"
...
"               "))
        ...
        self.queueExcludeTextEdit.setToolTip(_translate("ActionsForm", "Words/characters ignored when determining card similarities.\n"
