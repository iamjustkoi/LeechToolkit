...
class Ui_ActionsForm(object):
    def setupUi(self, ActionsForm):
        ...
        self.checkBox = QtWidgets.QCheckBox(self.queueGroup)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout_9.addWidget(self.checkBox, 2, 0, 1, 1)
        ...
        self.frame_7 = QtWidgets.QFrame(self.queueGroup)
        ...
        self.gridLayout_9.addLayout(self.verticalLayout_16, 4, 0, 1, 1)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(6, 0, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, ActionsForm):
        ...
        self.checkBox.setText(_translate("ActionsForm", "Using the current deck"))
        self.queueSimilarCheckbox.setToolTip(
            _translate(
                "ActionsForm", "Using the given range:\n"
                               "                                                         Places the card near another one in the queue based on how\n"
                               "                                                         similar\n"
                               "                                                         they are.\n"
                               "                                                     "
            )
        ...
        self.queueSiblingCheckbox.setToolTip(
            _translate(
                "ActionsForm", "Using the given range:\n"
                               "                                                 Place the card next to another one if they\'re each siblings of the same\n"
                               "                                                 note-type.\n"
                               "                                             "
            )
        )
