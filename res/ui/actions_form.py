...
class Ui_ActionsForm(object):
    def setupUi(self, ActionsForm):
        ...
        self.verticalFrame.setSpacing(0)
        ...
        self.gridLayout_9.addLayout(self.verticalLayout_16, 3, 0, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.queueSiblingCheckbox, 5, 0, 1, 1)
    ...
    def retranslateUi(self, ActionsForm):
        ...
        self.rescheduleResetCheckbox.setToolTip(
            _translate(
                "ActionsForm", "Updates the card\'s interval using the time between the current day and the\n"
                               "                                     updated\n"
                               "                                     date.\n"
                               "                                 "
            )
        ...
        self.queueIncludeFieldsCheckbox.setToolTip(
            _translate(
                "ActionsForm", "Filters to only match\n"
                               "                                                                                             the\n"
        ...
        self.queueRatioSlider.setToolTip(
            _translate(
                "ActionsForm", "Controls how similar a card\'s fields must be for it to be\n"
                               "                                                 considered\n"
                               "                                                 \"similar\".\n"
                               "                                             "
            )
