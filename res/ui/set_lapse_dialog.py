...
class Ui_SetLapseDialog(object):
    def setupUi(self, SetLapseDialog):
        ...
        self.label = QtWidgets.QLabel(parent=SetLapseDialog)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.lineEdit = QtWidgets.QLineEdit(parent=SetLapseDialog)
        self.lineEdit.setObjectName("lineEdit")
        self.verticalLayout.addWidget(self.lineEdit)
        self.updateLeechesCheckbox = QtWidgets.QCheckBox(parent=SetLapseDialog)
        self.updateLeechesCheckbox.setObjectName("updateLeechesCheckbox")
        self.verticalLayout.addWidget(self.updateLeechesCheckbox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SetLapseDialog)
