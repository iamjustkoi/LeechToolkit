...
class Ui_ReverseForm(object):
    ...
    def retranslateUi(self, ReverseForm):
        ...
        self.useLeechThresholdCheckbox.setToolTip(_translate("ReverseForm", "Use the same threshold as the current leech threshold (Anki Default:\n"
"                                             8).\n"
"                                         "))
        ...
        self.consAnswerSpinbox.setToolTip(_translate("ReverseForm", "Number of correct (not again) answers in a row to consider a card\n"
"                                             reversed.\n"
"                                         "))
