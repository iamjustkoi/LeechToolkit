...
class Ui_ReverseForm(object):
    def setupUi(self, ReverseForm):
        ...
        self.reverseGroup = QtWidgets.QGroupBox(parent=ReverseForm)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.reverseGroup.sizePolicy().hasHeightForWidth())
        self.reverseGroup.setSizePolicy(sizePolicy)
        self.reverseGroup.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.reverseThresholdLabel = QtWidgets.QLabel(parent=self.reverseGroup)
        ...
        self.useLeechThresholdCheckbox = QtWidgets.QCheckBox(parent=self.reverseGroup)
        ...
        self.reverseThresholdSpinbox = QtWidgets.QSpinBox(parent=self.reverseGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.consPrefixLabel = QtWidgets.QLabel(parent=self.reverseGroup)
        ...
        self.consAnswerSpinbox = QtWidgets.QSpinBox(parent=self.reverseGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.consSuffixLabel = QtWidgets.QLabel(parent=self.reverseGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.reverseMethodDropdown = QtWidgets.QComboBox(parent=self.reverseGroup)
    ...
    def retranslateUi(self, ReverseForm):
        ...
        self.reverseGroup.setToolTip(_translate("ReverseForm", "Reverse card lapses based on the number of correct review answers they have."))
        ...
        self.useLeechThresholdCheckbox.setToolTip(_translate("ReverseForm", "Use the same threshold as the current leech threshold (Anki Default: 8)."))
        self.useLeechThresholdCheckbox.setText(_translate("ReverseForm", "Same as Leech Threshold"))
        self.reverseThresholdSpinbox.setToolTip(_translate("ReverseForm", "Un-leeches any cards with a lapse count below this value."))
        self.consPrefixLabel.setText(_translate("ReverseForm", "Every"))
        self.consAnswerSpinbox.setToolTip(_translate("ReverseForm", "Number of correct (not again) answers in a row to consider a card reversed.\n"
"                                         "))
