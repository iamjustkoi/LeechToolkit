...
class Ui_FieldWidgetItem(object):
    def setupUi(self, FieldWidgetItem):
        ...
        self.methodDropdown = QtWidgets.QComboBox(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.methodDropdown.addItem("")
        self.methodDropdown.addItem("")
        self.horizontalLayout_4.addWidget(self.methodDropdown)
        ...
        self.inputEdit.setMinimumSize(QtCore.QSize(24, 24))
