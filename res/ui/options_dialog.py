...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.queueExcludeFieldEdit = QtWidgets.QTextEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.queueExcludeFieldEdit.sizePolicy().hasHeightForWidth())
        self.queueExcludeFieldEdit.setSizePolicy(sizePolicy)
        self.queueExcludeFieldEdit.setMinimumSize(QtCore.QSize(0, 0))
        self.queueExcludeFieldEdit.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.queueExcludeFieldEdit.setTabChangesFocus(True)
        self.queueExcludeFieldEdit.setLineWrapMode(QtWidgets.QTextEdit.NoWrap)
        self.queueExcludeFieldEdit.setObjectName("queueExcludeFieldEdit")
        self.verticalLayout_9.addWidget(self.queueExcludeFieldEdit)
        ...
        self.addFieldButton = QtWidgets.QPushButton(self.editFieldsGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.addFieldButton.sizePolicy().hasHeightForWidth())
        self.addFieldButton.setSizePolicy(sizePolicy)
        self.addFieldButton.setObjectName("addFieldButton")
        self.verticalLayout_8.addWidget(self.addFieldButton)
