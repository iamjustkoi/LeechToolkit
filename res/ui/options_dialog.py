...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.OptionsScrollWidget.setGeometry(QtCore.QRect(0, 0, 306, 415))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 397, 325))
