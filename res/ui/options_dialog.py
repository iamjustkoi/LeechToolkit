...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 479, 771))
        ...
        self.frame_4 = QtWidgets.QFrame(self.collapsibleLeechActionsGroup)
        ...
        self.queueIncludeFieldsCheckbox = QtWidgets.QCheckBox(self.groupBox_2)
        self.queueIncludeFieldsCheckbox.setObjectName("queueIncludeFieldsCheckbox")
        self._2.addWidget(self.queueIncludeFieldsCheckbox)
...
"Places the card near another one in the queue based on how similar they are."))
        ...
        self.groupBox_3.setTitle(_translate("OptionsDialog", "Ignored Text"))
        self.groupBox_2.setTitle(_translate("OptionsDialog", "Filtered Fields"))
        self.queueIncludeFieldsCheckbox.setToolTip(_translate("OptionsDialog", "Filters to only match the following fields instead of filtering them out."))
