...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.reverseThreshold.sizePolicy().hasHeightForWidth())
        self.reverseThreshold.setSizePolicy(sizePolicy)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 463, 325))
