...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 479, 750))
        ...
        self.editFieldsList = QtWidgets.QListWidget(self.collapsibleLeechActionsGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.editFieldsList.sizePolicy().hasHeightForWidth())
        self.editFieldsList.setSizePolicy(sizePolicy)
        ...
        self.addFieldButton = QtWidgets.QPushButton(self.collapsibleLeechActionsGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
>>>>>>> 1ad25cb (Adjusted field editables expansion and draw properties)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.collapsibleLeechActionsGroup)
...
"Place the card next to another one if the other card matches a preset filter."))
        ...
        self.groupBox_2.setTitle(_translate("OptionsDialog", "Filters"))
