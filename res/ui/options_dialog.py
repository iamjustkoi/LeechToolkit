...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.OptionsScrollWidget.setGeometry(QtCore.QRect(0, 0, 313, 142))
    ...
    def retranslateUi(self, OptionsDialog):
        ...
        self.almostCheckbox.setText(_translate("OptionsDialog", "Show marker on cards that are about to be leeched"))
