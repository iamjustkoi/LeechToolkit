...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 479, 503))
        ...
        self.leechActionsLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.checkBox_2)
...
"Place the card next to another one if the other card matches a preset pattern."))
