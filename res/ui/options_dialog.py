...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.OptionsScrollWidget.setGeometry(QtCore.QRect(0, 0, 370, 165))
        ...
        self.browseButtonCheckbox = QtWidgets.QCheckBox(self.OptionsScrollWidget)
        self.browseButtonCheckbox.setChecked(True)
        self.browseButtonCheckbox.setObjectName("browseButtonCheckbox")
        self.optionsScrollLayout.addWidget(self.browseButtonCheckbox)
