...
def load_action_manager(context: aqt.reviewer.Reviewer):
    if not mw.col.decks.is_filtered(mw.col.decks.get_current_id()):
        global action_manager, user_conf, deck_conf_dict, max_fails

        deck_conf_dict = mw.col.decks.config_dict_for_deck_id(mw.col.decks.get_current_id())
